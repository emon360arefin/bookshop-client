...
const Header = () => {
    ...
    return (
        <div className={`${scroll ? 'bg-white shadow-sm ' : ' bg-blue-50 shadow-none backdrop-blur-lg'}  header z-[15] sticky top-0 -mb-24`}>
            <div className={`max-w-7xl mx-auto flex transition-all duration-500 ease-in-out ${scroll ? 'h-auto md:h-[70px]' : 'h-auto md:h-[90px]'}`}>
